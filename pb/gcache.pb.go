...
func (x *ResponseForDelete) Reset() {
	*x = ResponseForDelete{}
	mi := &file_gcache_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResponseForDelete) Descriptor() ([]byte, []int) {
	return file_gcache_proto_rawDescGZIP(), []int{2}
}
...
var file_gcache_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
